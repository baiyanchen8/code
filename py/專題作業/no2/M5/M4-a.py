...
for i in range (0,height,n):
    for j in range(0,width,n):
        ...
        # 篡改
        if tamper==1:
            hashcode[0]=kLsb(baboon[i][j],1)[0]
            hashcode[1]=kLsb(baboon[i][j+1],1)[0]
            hashcode[2]=kLsb(baboon[i+1][j],1)[0]
            hashcode[3]=kLsb(baboon[i+1][j+1],1)[0]
